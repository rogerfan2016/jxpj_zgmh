package com.zfsoft.monitor.dao.daointerface;
...
public interface IMonitorDao {
     ...
     * @return
     */
    public int getPatrolsCount(PatrolQuery query);
     ...
     * @return
     */
    public List<PatrolEntity> getPatrols(PatrolQuery query);
     ...
     * @param model
     */
    public int savePatrol(PatrolEntity model);
    ...
    * @return
     */
    public List<PatrolDetailEntity> findPatrolDetailList(PatrolQuery query);
     ...
     * @param model
     */
    public void updatePatrolDetail(PatrolDetailEntity model);
