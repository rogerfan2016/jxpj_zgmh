...
<html>
  <head>
    ...
    <script type="text/javascript">
      ...
      // 查看饼图漏斗图图表
      function viewReportPieChart(xn,xq,kcdm,jxb) {
        showWindow("统计汇总图表", "<%=request.getContextPath()%>/evaluation/clearData_viewReportByPieChart.html?query.xn="+xn+"&query.xq="+xq+"&query.kcdm="+kcdm+"&query.jxb="+jxb, "750","480");
      }
      
      // 查看柱状图折线图图表
      function viewReportBarChart(xn,xq,kcdm,jxb) {
        showWindow("统计汇总图表", "<%=request.getContextPath()%>/evaluation/clearData_viewReportByBarChart.html?query.xn="+xn+"&query.xq="+xq+"&query.kcdm="+kcdm+"&query.jxb="+jxb, "750","480");
      }
      
      function refreshList() {
        var form = $("#search");
        form.attr("action", "<%=request.getContextPath()%>/evaluation/clearData_searchCourseWeightSumList.html");
        form.submit();
      }
          ...
          <table width="100%" class="dateline tablenowrap">
            ...
            <tbody id="list_body">
              ...
              <tr name="tr">
                ...
                <td>${info.kcmc }</td>
                <td>${info.skjssl }
                <c:if test="${info.skjssl > 1 }">
                <a href="#" onclick="viewReportPieChart('${info.xn}','${info.xq}','${info.kcdm }','');">
                	<img src="../image/ico_bt.png" alt="" />
                </a>
                <a href="#" onclick="viewReportBarChart('${info.xn}','${info.xq}','${info.kcdm }','');">
                ...
                <a href="#" onclick="viewReportPieChart('${info.xn}','${info.xq}','${info.kcdm }','true');">
                	<img src="../image/ico_bt.png" alt="" />
                </a>
                <a href="#" onclick="viewReportBarChart('${info.xn}','${info.xq}','${info.kcdm }','true');">
                	<img src="../image/ico_zzt.png" alt="" />
                </a>
                </c:if>
                </td>
