...
<script type="text/x-handlebars-template" id="amz-tpl">
 ...
 <div data-am-widget="tabs" class="am-tabs am-tabs-default">
		...
		<c:choose>
			...
			<li class="am-active"><a onclick="showPanel('panel0','WAIT_AUDITING');">待审核</a></li>
            <li class=""><a onclick="showPanel('panel1','HAS_AUDITED');">已审核</a></li>
			</c:when>
			 <c:otherwise>
			<li class=""><a onclick="showPanel('panel0','WAIT_AUDITING');">待审核</a></li>
            <li class="am-active"><a onclick="showPanel('panel1','HAS_AUDITED');">已审核</a></li>
			</c:otherwise>
...
<div data-am-widget="list_news" class="am-list-news am-list-news-default" >
  ...
  <ul class="am-list">
	...
	<li class="am-g am-list-item-dated">	
		<c:choose>
		<c:when test="${status == 'WAIT_AUDITING' }">
          <a href="mobile_pendingAffairDetail.html?classId=${page.classId}&workId=${page.id}" class="am-list-item-hd ">
...
<script type="text/javascript"> 
    ...
    var leftc = [];
    var obj = {};
    obj.link = "../evaluation/mobile_pendingAffairList.html";
    ...
    function showPanel(id,staus) {
        $("#panel0").hide();
        $("#panel1").hide();
        //$("#panel2").hide();
        $("#" + id).show();
        location.href = "../evaluation/mobile_pendingAffairByType.html?status="+staus;
    };
