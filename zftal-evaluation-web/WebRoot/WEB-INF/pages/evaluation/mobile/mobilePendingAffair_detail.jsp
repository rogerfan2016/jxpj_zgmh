 ...
 <script type="text/javascript" src="<%=request.getContextPath() %>/js/mobile/billaudit.js"></script>
    ...
    $(function(){
			var params={idInput:"${infoChange.id}",
						...
						returnUrl:"/evaluation/mobile_pendingAffairByType.html"};
			$("#back").click(function(){//功能条增加按钮
                location.href = _path+"/evaluation/mobile_pendingAffairByType.html";
            });
...
<script type="text/javascript"> 
    ...
    var leftc = [];
    var obj = {};
    obj.link = "../evaluation/mobile_pendingAffairByType.html";
