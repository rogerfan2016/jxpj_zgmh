...
<html>
    ...
    <script type="text/javascript">
      $(function() {
        ...
        $("#btn_dc").click(function() {
          window.open("<%=request.getContextPath()%>/evaluation/student_exportCheckinAllByClass.html?" + $("#search").serialize());
        });
  ...
  <div class="toolbox">
    ...
    <form action="<%=request.getContextPath()%>/evaluation/student_checkinAllByClass.html" name="search" id="search" method="post">
      <div class="searchtab">
