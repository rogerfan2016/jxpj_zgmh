...
<head>
    ...
    $(function(){
        $("#cl_btn").click(function(){
            ...
            $.post("<%=request.getContextPath()%>/feedback/handle_personHandleFeedback.html",
                $("#form_edit").serialize(),function(data){
                    data = eval(data);
				  	if(data.success){
                    	closeWin();
                        window.location.href = "<%=request.getContextPath()%>/feedback/handle_personHandleFeedBackList.html";
                    }else{
                        showWarning("处理信息失败");
                    }
        ...
        $("#back_btn").click(function(){
        	...
        	$("#clr").val("");
            $.post("<%=request.getContextPath()%>/feedback/handle_backPersonHandleFeedback.html",
                $("#form_edit").serialize(),function(data){
                    data = eval(data);
				  	if(data.success){
                    	closeWin();
