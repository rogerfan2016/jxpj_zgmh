...
<html>
        ...
        fillRows("20", "", "", false);//填充空行
         ...
         // 导出
       		$("#btn_dc").click(function() {
       	  		window.open("<%=request.getContextPath()%>/feedback/handle_schoolExportFeedBack.html?" + $("#search").serialize());
       		});
      });
      
       //反馈信息处理
      function schoolHandleFeedback(xxid){
      		var url=_path+'/feedback/handle_schoolHandleFeedbackView.html?xxid='+xxid;
  ...
  <body>
    ...
    <form action="<%=request.getContextPath()%>/feedback/handle_schoolHandleFeedBackList.html" name="search" id="search" method="post">
      ...
      <div class="formbox">
        ...
        <div class="con_overlfow">
          <table width="100%" class="dateline tablenowrap">
            <thead id="list_head">
              <tr>
              	<td width="2%" style="text-align:center;">操作</td>
                ...
                <td width="15%" style="text-align:center;">教师名称</td>
            ...
            <tbody id="list_body">
              ...
              <tr name="tr" align="center"">
              	...
              	<td>
              		<c:if test="${info.clhj eq '1' }"><a id="handle" class="btn_xg" onclick="schoolHandleFeedback'${info.xxid}');">处理</a></c:if>
