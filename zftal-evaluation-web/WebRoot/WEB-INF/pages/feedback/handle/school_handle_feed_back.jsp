...
<head>
    ...
    $(function(){
        $("#cl_btn").click(function(){
            ...
            $.post("<%=request.getContextPath()%>/feedback/handle_schoolHandleFeedback.html",
                $("#form_edit").serialize(),function(data){
                    data = eval(data);
				  	if(data.success){
                    	closeWin();
                        window.location.href = "<%=request.getContextPath()%>/feedback/handle_schoolHandleFeedBackList.html";
                    }else{
                        showWarning("处理信息失败");
                    }
        ...
        $("#back_btn").click(function(){
        	...
        	$("#clr").val("");
            $.post("<%=request.getContextPath()%>/feedback/handle_backSchoolHandleFeedback.html",
                $("#form_edit").serialize(),function(data){
                    data = eval(data);
				  	if(data.success){
                    	closeWin();
