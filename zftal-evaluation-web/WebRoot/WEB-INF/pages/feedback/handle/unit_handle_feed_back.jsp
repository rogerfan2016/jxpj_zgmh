    ...
    $(function(){
        $("#cl_btn").click(function(){
            ...
            $.ajax({ 
				  ...
				  dataType:"json",
				  url:"<%=request.getContextPath()%>/feedback/handle_unitHandleFeedback.html", 
        ...
        $("#back_btn").click(function(){
        	...
        	$("#clr").val("");
            $.post("<%=request.getContextPath()%>/feedback/handle_backUnitHandleFeedback.html",
        ...
        <div class="tab">
            <table width="100%"  border="0" class="formlist" cellpadding="0" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                		<th><span class="red">*</span>处理人</th>
                		<td colspan="5">
                			<ct:selectPerson id="clr" name="model.clr" single="true" width="200px" value="${model.clr}"/>
                		</td>
                	</tr>
