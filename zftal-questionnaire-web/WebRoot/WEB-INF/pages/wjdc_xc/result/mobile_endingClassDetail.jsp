...
<script type="text/javascript">
    if("${wjModel.djzt != '未答卷'}"=="true"){
        jQuery("#but_tj").remove();
    }
    /**问卷提交验证*/
    function wjSubmitCheckMe(){
        if(validate()){
        	var url="inspection_mobile/result_saveEndingClassWjDa.html";
    ...
    if(jQuery("#result").val()!=""){
    	 location.href= _path+"/inspection_mobile/result_endingClassList.html?type=${type}&query.status=1";
    }
</script>
...
<script type="text/javascript"> 
    ...
    leftc.push(obj);
    data.header.content.title = "结课评价问卷";
