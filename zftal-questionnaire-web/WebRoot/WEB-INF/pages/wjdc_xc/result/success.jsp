...
<body>
    ...
    <div style="text-align:center; margin:20px 0 10px;">
        <div class="formfield" style="padding-bottom:30px;">
            <div class="description">您的答卷已经提交，感谢您的参与！<font color="red"><span  id="time">3</span></font>秒后系统将自动返回列表页面</div>
     ...
     function backList(){
        var url = _path+"/inspection_mobile/result_list.html?type=<%=request.getParameter("type")%>";
