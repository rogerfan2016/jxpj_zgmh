...
<body>
    <form action="<%=request.getContextPath() %>/inspection/config_objectList.html" method="post">
        ...
        <div class="searchtab">
            <table width="100%">
                ...
                <tbody>
                    <th width="10%">用户名</th>
                      <td width="20%">
                        <input name="query.params['gh']" value="${query.params['gh'] }"/>
                        <input type="hidden" name="query.params['type']" value="${query.params['type'] }"/>
                      </td>
                    <th width="10%">姓名</th>
                      <td width="20%">
                        <input name="query.params['xm']" value="${query.params['xm'] }"/>
                      </td>
                </tbody>
            </table>
        </div>
